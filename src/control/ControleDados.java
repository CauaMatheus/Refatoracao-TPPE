...
public class ControleDados {
	...
	public boolean inserirEditarFilme(String[] dadosFilmes) {
		if (!dadosFilmes[2].matches("[0-9]+")|| !dadosFilmes[4].matches("[0-9]+")|| !dadosFilmes[6].matches("[0-9]+")|| !dadosFilmes[7].matches("[0-9]+")
				|| !dadosFilmes[8].matches("[0-9]+") || !dadosFilmes[8].matches("[0-9]+") ) {
			return false;
		} else {
